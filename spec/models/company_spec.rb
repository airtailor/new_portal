...
RSpec.describe Company, type: :model do
  it "is invalid without a name" do 
    invalid_company = FactoryGirl.build(:company, name: nil)
  ...
  describe "#hq_store" do 
    it "lists the company's hq store if it has one" do 
      ...
      valid_hq = FactoryGirl.create(:hq, company: valid_company)
  ...
  describe "#stores" do 
    it "lists all the company's stores" do 
      valid_company = FactoryGirl.create(:company)
      valid_store = FactoryGirl.create(:store, company: valid_company)
