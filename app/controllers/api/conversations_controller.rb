class Api::ConversationsController < ApplicationController
  ...
  def index
    ...
    conversations = store.name == "Air Tailor" ? Conversation.all : store.conversations
    data = conversations.as_json({methods: [:sender, :recipient, :sender_read, :recipient_read]})
    render :json => data
  end
