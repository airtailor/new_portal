class Order < ApplicationRecord
  ...
  has_one :outgoing_shipment, class_name: "Shipment", foreign_key: :outgoing_shipment_id
  has_one :incoming_shipment, class_name: "Shipment", foreign_key: :incoming_shipment_id
